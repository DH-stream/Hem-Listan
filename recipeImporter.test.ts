...
test("adds the article image when a non-JSON-LD candidate wins", () => {
  const html = `
    <script type="application/ld+json">
      {
        "@type": "Recipe",
        "name": "Ofullständigt recept",
        "recipeIngredient": ["1 st päron"]
      }
    </script>
    <main class="wrh-main">
    ...
    <section class="product-grid">
      <a href="/products/isglassform">
        <img alt="Isglassform" src="//cdn.shopify.com/s/files/product.jpg">
      </a>
    </section>
  `;
